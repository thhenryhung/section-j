...
**Live at** [section-j.pages.dev](https://section-j.pages.dev) — passphrase required,
...
| **Jocial** | Dinners of six and 1:1 coffee chats, assigned automatically every three weeks, alternating between the two. Allocation minimises repeat encounters. Shows your group, how many of the section you have met, and how to sit a round out. Rounds are generated by an organiser running `npm run pair` — there is no in-app "generate" button, by design. |
